...
Test suite for the ACKProtocol class object and module
...
class TestImports(unittest.TestCase):
    ...
    def test_baseprotocol(self):
        self.assertEqual(baseprotocol, ackprotocol.baseprotocol)
...
class TestClassBasics(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.x = ackprotocol.ACKProtocol(self.socket)

    def test_instance(self):
        self.assertIsInstance(self.x, ackprotocol.ACKProtocol)
